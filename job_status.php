...
$timecreated = (int) ($job->timecreated ?? 0);
$timemodified = (int) ($job->timemodified ?? 0);
$durationseconds = ($timecreated > 0 && $timemodified >= $timecreated) ? ($timemodified - $timecreated) : null;
